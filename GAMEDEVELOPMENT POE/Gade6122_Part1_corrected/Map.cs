    ...
    public class Map
    {
        ...
        private Tile Create(TileType type)
        {
            ...
            else if (type == TileType.Weapon)
            {
                ...
                if (itemType == 0)
                {
                    map[tileX, tileY] = new MeleeWeapon(tileX, tileY);
                }
                else if (itemType == 1)
                {
                    map[tileX, tileY] = new RangedWeapon(tileX, tileY);
                }
            }
        ...
        public override string ToString()
        {
            ...
            for (int y = 0; y < height; y++)
            {
                for (int x = 0; x < width; x++)
                {
                    ...
                    {
                        MeleeWeapon meleeWeapon = (MeleeWeapon)tile;
                        s += meleeWeapon.meleeWeaponChar;
                    }
                    else if (tile is RangedWeapon)
                    {
                        RangedWeapon rangedweapon = (RangedWeapon)tile;
                        s += rangedweapon.rangedWeaponChar;
                    }
